export default {
  ...
  // 更新履歴
  changelog: {
    new_0_6_11_1: 'LAN device discovery に pairing approvals、request history、duplicate request handling、status sync、device access revoke 時の cleanup を追加しました',
    new_0_6_11_2: 'LAN peer access は MCP から利用でき、bundled MCP startup、command shims、reconnecting peer sockets、local connection listing、terminal session caps に対応しました',
    new_0_6_11_3: 'Unified backend TTS synthesis と MiMo voice cloning settings が利用可能になり、保存前の playback に対応しました',
    new_0_6_11_4: 'Gateway autostart settings は Profile の multi-select filtering、whitelist behavior、startup profile selection tests に対応しました',
    new_0_6_11_5: 'Chat scrolling と motion は bottom-follow tuning、initial bottom scroll fixes、scroll lock updates、reduced-motion fade handling により安定しました',
    new_0_6_11_6: 'Agent Bridge と runtime flows は abort timeout handling、resume startup guards、execute-code approval memory、Windows Gateway recovery、dev terminal proxy fixes により安定しました',
    new_0_6_11_7: 'Web UI origin policy、security headers、server-token loopback access guards により security を強化しました',
    new_0_6_11_8: 'Group chat と tool output rendering は reconnect 後の room rejoin、reasoning/tool boundaries の保持、より安全な tool payload rendering、改善された diff display により安定しました',
    new_0_6_11_9: 'Skills と Workspace flows は external skill directories、import/delete refresh、sourcePath grouping、localized folder picker text、mobile skill action icons に対応しました',
    new_0_6_11_10: 'Device layout、session titles、browser tab titles、Kanban parent task IDs、OpenRouter attribution text を改善しました',
