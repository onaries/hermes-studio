export default {
  ...
  drawer: {
    ...
    resize: '調整抽屜大小',
    open: '開啟抽屜',
    repositionHint: '拖曳可將抽屜按鈕吸附到頂部、中間或底部',
    pin: '固定抽屜',
    unpin: '取消固定抽屜',
    files: '工作區',
    todo: {
      tab: '待辦',
      title: '進行中的待辦',
      subtitle: '只顯示此聊天工作階段中進行中的待辦項目。',
      total: '進行中',
      lastUpdated: '最後更新 {time}',
      emptyTitle: '沒有進行中的待辦',
      emptyDescription: '當 Hermes 將 Todo 標記為進行中時，會顯示在這裡。',
    },
  },
  ...
  chat: {
    ...
    webUiSessions: '工作階段',
    allProfiles: '全部設定',
    profileMissingModelsTip: '該會話所屬設定「{profile}」沒有可用的 provider 或模型',
        sessionNeedsApproval: '待審批',
        sessionNeedsClarify: '待回答',
    ...
    clarifySubmit: '回覆',
    clarifyDismiss: '忽略',
    browserNotificationsEnable: '允許瀏覽器通知',
    browserNotificationsUnsupported: '目前環境不支援瀏覽器通知。',
    browserNotificationsEnabled: '瀏覽器通知已啟用。',
    approvalNotificationTitle: 'Hermes 需要核准',
    approvalNotificationBody: '有工具執行核准正在等待。',
    clarifyNotificationTitle: 'Hermes 需要你的回覆',
    clarifyNotificationBody: 'Agent 正在等待你的回答。',
    completionNotificationTitle: 'Hermes 已完成',
    completionNotificationBody: '{title} 已完成。',
    completionFailedNotificationTitle: 'Hermes 任務失敗',
    completionFailedNotificationBody: '{title} 因錯誤結束。',
    clarifyExpiresIn: '剩餘 {time}',
    clarifyExpired: '已逾時',
    ...
    terminalRunning: '終端機執行中 · {elapsed}',
    toolSummary: {
      query: 'Query: {value}',
      path: 'Path: {value}',
      url: 'URL: {value}',
    ...
    toolAggregate: {
      ...
      elapsedDuration: '耗時 {duration}',
      durationLessThanSecond: '<1秒',
      durationSeconds: '{count}秒',
      durationMinutes: '{minutes}分 {seconds}秒',
      durationHours: '{hours}小時 {minutes}分',
    },
  ...
  settings: {
    ...
    display: {
      ...
      showToolMascotDesktop: '顯示桌面工具角色',
      showToolMascotDesktopHint: '在桌面端即時工具呼叫旁顯示角色',
      showToolMascotMobile: '顯示行動版工具角色',
      showToolMascotMobileHint: '在行動版即時工具呼叫旁顯示角色',
      showDrawerRainbow: '顯示抽屜彩虹光效',
      showDrawerRainbowHint: '在抽屜按鈕周圍顯示動態彩虹光效',
      pinRightDrawer: '固定右側抽屜',
      pinRightDrawerHint: '在桌面端將右側抽屜保持為永遠可見的固定側欄',
      autoOpenPatchDrawer: '自動展開 patch 詳細',
      autoOpenPatchDrawerHint: 'patch 工具完成後，在即時工具記錄中自動展開 diff/詳細內容',
      showWorkspaceFileTree: 'Workspace 檔案樹',
      showWorkspaceFileTreeHint: '顯示 Workspace 抽屜內左側的檔案樹區域',
      ...
      browserNotifyOnComplete: '完成時瀏覽器通知',
      browserNotifyOnCompleteHint: '聊天執行結束時顯示瀏覽器/桌面通知',
      browserNotifyOnCompleteDenied: '瀏覽器通知已被阻擋。請先在瀏覽器或系統設定中允許。',
      bellOnCompleteHint: 'AI 回覆完成時播放提示音',
      mobileEnterToSend: '行動裝置 Enter 送出',
      mobileEnterToSendHint: '關閉後，行動裝置鍵盤的 Enter 只會換行，請使用送出按鈕提交。',
      terminalFontSize: '終端機字體大小',
      terminalFontSizeHint: '調整終端機文字大小',
      terminalFontFamily: '終端機字體',
      terminalFontFamilyHint: '終端機文字使用的 CSS font-family；留空則使用預設值',
  ...
  githubPreview: {
    ...
    path: "預覽路徑",
    webuiHome: "預覽資料目錄",
    activeVersion: "目前已套用版本",
    activePath: "已套用路徑",
    activeUpdatedAt: "套用時間",
    currentTag: "目前 Tag",
    repoReady: "倉庫就緒",
    dependencies: "依賴已安裝",
    running: "執行狀態",
  ...
  terminal: {
    ...
    mobileShortcutBar: '行動版終端機輔助鍵',
    hideMobileShortcutBar: '隱藏行動版終端機輔助鍵',
    showMobileShortcutBar: '顯示行動版終端機輔助鍵',
  ...
  changelog: {
    ...
    new_0_6_14_1: '官網和文件完成更新：重新設計落地頁、強制淺色展示，並新增 Hermes Studio 用戶端手冊',
    new_0_6_14_2: '完成通知現在可在桌面殼和支援的瀏覽器中提示任務已結束',
    new_0_6_14_3: '桌面端新增自訂標題列、啟動閃屏、更寬的授權抽屜、置中的載入狀態，並修復 Linux 視窗控制按鈕',
    new_0_6_14_4: 'Workspace 資料夾增加直接操作，檔案和目錄在介面中更容易開啟、管理和使用',
    new_0_6_14_5: 'Profile 與運行時啟動更穩定：拒絕保留名稱重新命名、修復 Linux deb 啟動路徑、移除舊 gateway 清理邏輯，並減少 Coding Agent 恢復時不必要的 bridge 檢查',
    new_0_6_14_6: '群聊身份在更換瀏覽器後更可靠，agent 和成員名稱會跟隨帳號/Profile 狀態保持一致',
    new_0_6_14_7: '靜態資源壓縮處理已修復，打包 Web UI 檔案交付更精簡也更安全',
    new_0_6_14_8: '裝置配對更安全：啟動時生成配對碼，請求進入審批前需要校驗，頻繁錯誤會被限制，同時保留可信區域網路發現邏輯',
    new_0_6_14_9: '桌面端 Claude Code 偵測會讀取使用者 shell PATH 和常見套件管理器目錄，macOS 與 Linux 上更容易找到已安裝的 coding agent',
    new_0_6_14_10: 'Hermes 寫入門禁覆蓋記憶和技能寫入，支援待審核列表、bridge 模組拆分、本地化授權介面，並改善桌面啟動體驗',
