export default {
  ...
  chat: {
    ...
    slashCommands: {
      ...
      btw: 'Ask a side question without saving it to history',
    ...
    approvalDeny: 'Deny',
    approvalExpiresIn: 'Expires in {time}',
    ...
    browserNotificationsEnable: 'Enable browser alerts',
    browserNotificationsUnsupported: 'Browser notifications are not supported here.',
    browserNotificationsEnabled: 'Browser alerts enabled.',
    approvalNotificationTitle: 'Hermes needs approval',
    approvalNotificationBody: 'A tool approval is waiting.',
    clarifyNotificationTitle: 'Hermes needs your answer',
    clarifyNotificationBody: 'The agent is waiting for your reply.',
    completionNotificationTitle: 'Hermes finished',
    completionNotificationBody: '{title} is done.',
    completionFailedNotificationTitle: 'Hermes task failed',
    completionFailedNotificationBody: '{title} ended with an error.',
    clarifyExpiresIn: 'Expires in {time}',
    clarifyExpired: 'Expired',
    newCliChat: 'New CLI',
    ...
    terminalRunning: 'Terminal running · {elapsed}',
    toolSummary: {
      query: 'Query: {value}',
      path: 'Path: {value}',
      url: 'URL: {value}',
  ...
  settings: {
    ...
    display: {
      ...
      showToolMascotDesktop: 'Show desktop tool mascot',
      showToolMascotDesktopHint: 'Show the character beside live tool calls on desktop',
      showToolMascotMobile: 'Show mobile tool mascot',
      showToolMascotMobileHint: 'Show the character beside live tool calls on mobile',
      showDrawerRainbow: 'Drawer rainbow glow',
      showDrawerRainbowHint: 'Show the animated rainbow glow around the drawer button',
      pinRightDrawer: 'Pin right drawer',
      pinRightDrawerHint: 'Keep the right drawer visible as a fixed side panel on desktop',
      autoOpenPatchDrawer: 'Expand patch details automatically',
      autoOpenPatchDrawerHint: 'When a patch tool finishes, expand its diff/details in the live tool trace',
      showWorkspaceFileTree: 'Workspace file tree',
      showWorkspaceFileTreeHint: 'Show the left file tree inside the Workspace drawer',
      ...
      browserNotifyOnComplete: 'Browser alert on completion',
      browserNotifyOnCompleteHint: 'Show a browser/desktop notification when a chat run finishes',
      browserNotifyOnCompleteDenied: 'Browser notifications are blocked. Enable them in browser or OS settings first.',
      ...
      terminalFontSizeHint: 'Adjust terminal text size',
      terminalFontFamily: 'Terminal font family',
      terminalFontFamilyHint: 'CSS font-family for terminal text; clear to use the default',
  ...
  githubPreview: {
    ...
    activePath: "Applied Path",
    activeUpdatedAt: "Applied At",
    ...
    applySuccess: "Internal update installed; restarting",
  ...
  terminal: {
    ...
    mobileShortcutBar: 'Mobile terminal shortcut keys',
    hideMobileShortcutBar: 'Hide mobile terminal shortcut keys',
    showMobileShortcutBar: 'Show mobile terminal shortcut keys',
  ...
  changelog: {
    ...
    new_0_6_14_4: 'Workspace folders gained direct actions so files and directories are easier to open, manage, and use from the UI',
    new_0_6_14_5: 'Profile and runtime startup are steadier with reserved profile rename protection, Linux deb launch fixes, removed legacy gateway cleanup, and fewer unnecessary bridge checks when resuming coding agents',
    new_0_6_14_6: 'Group chat identity is more reliable across browsers, keeping agent and member names aligned with account/profile state',
    new_0_6_14_7: 'Static asset delivery is leaner and safer after compression handling was fixed for packaged Web UI files',
    new_0_6_14_8: 'Device pairing is safer with per-start pairing codes, approval-gated requests, request throttling, and LAN discovery behavior preserved for trusted local flows',
    new_0_6_14_9: 'Desktop Claude Code detection now reads the user shell PATH and common package-manager locations so installed coding agents are found more reliably on macOS and Linux',
    new_0_6_14_10: 'Hermes write-gate controls now cover memory and skill writes with pending approval review, bridge module splitting, localized approval UI, and improved desktop startup behavior',
