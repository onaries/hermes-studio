...
jobTriggered: 'Job declenche',
  ...
  changelog: {
    ...
    new_0_6_12_10: 'Les autres ameliorations frontend incluent le fallback pour l appairage distant, le preset Atlas Cloud, des libelles de barre laterale plus clairs, une identite de deconnexion affinee et la suppression du reglage Busy Input non raccorde',
