...
jobTriggered: 'Job declenche',
  ...
  changelog: {
    new_0_6_11_1: 'La decouverte des appareils LAN inclut maintenant les approbations de pairing, l historique des demandes, la gestion des doublons, la synchronisation de statut et le nettoyage lors de la revocation d acces',
    new_0_6_11_2: 'L acces LAN peer est disponible via MCP avec demarrage MCP integre, command shims, peer sockets avec reconnexion, liste des connexions locales et sessions terminal limitees',
    new_0_6_11_3: 'La synthese TTS backend unifiee et les reglages de clonage vocal MiMo sont disponibles, avec lecture avant enregistrement',
    new_0_6_11_4: 'Les reglages Gateway autostart exposent le filtrage Profile via controles multi-select, le comportement whitelist et des tests de selection du Profile de demarrage',
    new_0_6_11_5: 'Le scroll et les animations du chat sont plus stables avec bottom-follow tuning, initial bottom scroll fixes, scroll lock updates et gestion du fade reduced-motion',
    new_0_6_11_6: 'Agent Bridge et les flux runtime sont plus fiables avec abort timeout handling, resume startup guards, memoire d approbation execute-code, recuperation Windows Gateway et fixes du proxy terminal dev',
    new_0_6_11_7: 'La securite est renforcee avec Web UI origin policy, security headers et guards d acces loopback pour server token',
    new_0_6_11_8: 'Group chat et le rendu tool output sont plus stables avec rejoin apres reconnect, preservation des reasoning/tool boundaries, rendu tool payload plus sur et meilleure vue diff',
    new_0_6_11_9: 'Skills et Workspace prennent en charge external skill directories, refresh import/delete, groupement par sourcePath, texte localise du folder picker et icones mobiles d actions skill',
    new_0_6_11_10: 'Le layout Devices, les titres de session, les titres browser tab, les Kanban parent task IDs et le texte d attribution OpenRouter ont ete polis',
