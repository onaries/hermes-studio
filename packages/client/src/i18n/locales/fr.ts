export default {
  ...
  drawer: {
    ...
    pin: 'Épingler le tiroir',
    unpin: 'Détacher le tiroir',
  ...
  chat: {
    ...
    browserNotificationsEnable: 'Autoriser les alertes du navigateur',
    browserNotificationsUnsupported: 'Les notifications du navigateur ne sont pas prises en charge ici.',
    browserNotificationsEnabled: 'Alertes du navigateur activées.',
    approvalNotificationTitle: 'Hermes attend une approbation',
    approvalNotificationBody: 'Une approbation d’outil est en attente.',
    clarifyNotificationTitle: 'Hermes attend votre réponse',
    clarifyNotificationBody: 'L’agent attend votre réponse.',
    completionNotificationTitle: 'Hermes a terminé',
    completionNotificationBody: '{title} est terminé.',
    completionFailedNotificationTitle: 'La tâche Hermes a échoué',
    completionFailedNotificationBody: '{title} s’est terminé avec une erreur.',
    clarifyExpiresIn: 'Expire dans {time}',
    clarifyExpired: 'Expiré',
    ...
    toolAggregate: {
      ...
      elapsedDuration: 'Durée {duration}',
    ...
    todoToolName: 'Todo',
    todoUpdated: 'Todo mis à jour',
    todoList: 'Liste Todo',
    todoMoreItems: '+{count} de plus',
    todoStatus: {
      pending: 'En attente',
...
jobTriggered: 'Job declenche',
  ...
  settings: {
    ...
    display: {
      ...
      showLiveTps: 'Afficher le TPS en direct',
      showLiveTpsHint: 'Affiche l’estimation des tokens par seconde dans la zone de saisie pendant le streaming',
      showToolMascot: 'Afficher la mascotte des outils',
      showToolMascotHint: 'Affiche le personnage à côté des appels d’outils en direct',
      showToolMascotDesktop: 'Afficher la mascotte des outils sur bureau',
      showToolMascotDesktopHint: 'Affiche le personnage à côté des appels d’outils en direct sur bureau',
      showToolMascotMobile: 'Afficher la mascotte des outils sur mobile',
      showToolMascotMobileHint: 'Affiche le personnage à côté des appels d’outils en direct sur mobile',
      showDrawerRainbow: 'Afficher l’éclat arc-en-ciel du tiroir',
      showDrawerRainbowHint: 'Affiche l’éclat arc-en-ciel animé autour du bouton du tiroir',
      pinRightDrawer: 'Épingler le tiroir droit',
      pinRightDrawerHint: 'Garder le tiroir droit visible comme panneau latéral fixe sur ordinateur',
      autoOpenPatchDrawer: 'Déplier les détails du patch automatiquement',
      autoOpenPatchDrawerHint: 'Quand l’outil patch se termine, déplie son diff / ses détails dans la trace d’outils en direct',
      showWorkspaceFileTree: 'Arborescence Workspace',
      showWorkspaceFileTreeHint: 'Affiche l’arborescence de fichiers à gauche dans le tiroir Workspace',
      showTerminalSessionList: 'Liste des sessions Terminal',
      showTerminalSessionListHint: 'Affiche la liste des sessions à gauche dans le tiroir Terminal',
      inlineDiffs: 'Diffs en ligne',
      inlineDiffsHint: 'Afficher les changements de code en ligne',
      bellOnComplete: 'Son de fin',
      browserNotifyOnComplete: 'Alerte navigateur à la fin',
      browserNotifyOnCompleteHint: 'Afficher une notification navigateur/bureau quand l’exécution du chat se termine',
      browserNotifyOnCompleteDenied: 'Les notifications du navigateur sont bloquées. Autorisez-les dans le navigateur ou l’OS.',
      bellOnCompleteHint: 'Jouer un son lorsque l\'IA a termine',
      mobileEnterToSend: 'Envoyer avec Entrée sur mobile',
      mobileEnterToSendHint: "Si désactivé, Entrée sur les claviers mobiles ajoute seulement une nouvelle ligne ; utilisez le bouton d’envoi.",
      terminalFontSize: 'Taille de police du terminal',
      terminalFontSizeHint: 'Ajuste la taille du texte du terminal',
      terminalFontFamily: 'Police du terminal',
      terminalFontFamilyHint: 'CSS font-family pour le texte du terminal ; laissez vide pour utiliser la valeur par défaut',
  ...
  githubPreview: {
    ...
    activeVersion: "Version appliquée",
    activePath: "Chemin appliqué",
    activeUpdatedAt: "Appliqué le",
    ...
    applySuccess: "Mise a jour interne installee; redemarrage",
  ...
  terminal: {
    ...
    mobileShortcutBar: 'Touches auxiliaires du terminal mobile',
    hideMobileShortcutBar: 'Masquer les touches auxiliaires du terminal mobile',
    showMobileShortcutBar: 'Afficher les touches auxiliaires du terminal mobile',
  ...
  changelog: {
    ...
    new_0_6_14_4: 'Les dossiers Workspace gagnent des actions directes pour ouvrir, gerer et utiliser fichiers et repertoires plus facilement',
    new_0_6_14_5: 'Le demarrage Profile et runtime est plus stable avec rejet des noms reserves, corrections du lancement deb Linux, suppression du nettoyage gateway legacy et moins de controles bridge inutiles lors de la reprise des Coding Agents',
    new_0_6_14_6: 'L identite du chat de groupe est plus fiable entre navigateurs, avec noms d agents et de membres alignes sur le compte/Profile',
    new_0_6_14_7: 'La livraison des assets statiques est plus legere et plus sure apres correction de la compression des fichiers Web UI packages',
    new_0_6_14_8: 'L appairage des appareils est plus sur avec code par demarrage, demandes soumises a approbation, limitation des erreurs et logique LAN conservee pour les flux locaux de confiance',
    new_0_6_14_9: 'La detection desktop de Claude Code lit maintenant le PATH du shell utilisateur et les emplacements courants des gestionnaires de paquets pour trouver les coding agents installes sur macOS et Linux',
    new_0_6_14_10: 'Hermes write gate couvre les ecritures memoire et skill avec revue des approbations en attente, decoupage des modules bridge, UI d approbation localisee et demarrage desktop ameliore',
  ...
  artifacts: {
    ...
    scrollToTop: 'Haut',
    hideList: 'Masquer la liste des artefacts',
    showList: 'Afficher la liste des artefacts',
    download: 'Télécharger',
    remove: 'Supprimer l’artefact',
    emptyTitle: 'Aucun artefact pour le moment',
    emptyDescription: 'Ouvrez un fichier Markdown ou texte généré depuis le chat pour le prévisualiser ici.',
    loadFailed: 'Impossible de charger l’artefact',
