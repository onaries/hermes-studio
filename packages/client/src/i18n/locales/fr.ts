...
jobTriggered: 'Job declenche',
  ...
  settings: {
    ...
    display: {
      ...
      fileIconTheme: 'Thème des icônes de fichiers',
      fileIconThemeHint: 'Choisir le style des icônes dans l’espace de travail, les pièces jointes et le sélecteur de dossiers',
      fileIconThemeColor: 'Couleur',
      fileIconThemeMono: 'Mono',
      fileIconThemeTerminal: 'Terminal',
      showTerminalSessionList: 'Liste des sessions Terminal',
      showTerminalSessionListHint: 'Affiche la liste de sessions à gauche sur desktop. Sur mobile, le bouton Sessions reste utilisé.',
  ...
  usage: {
    ...
    codingAgentBreakdown: 'Tokens de l’agent de code',
  ...
  artifacts: {
    ...
    openInArtifacts: 'Ouvrir dans les artefacts',
    download: 'Télécharger',
