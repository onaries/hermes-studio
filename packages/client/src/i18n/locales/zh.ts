export default {
  ...
  chat: {
    ...
    clarifySubmit: '回复',
    clarifyDismiss: '忽略',
    browserNotificationsEnable: '允许浏览器通知',
    browserNotificationsUnsupported: '当前环境不支持浏览器通知。',
    browserNotificationsEnabled: '浏览器通知已开启。',
    approvalNotificationTitle: 'Hermes 需要审批',
    approvalNotificationBody: '有工具执行审批正在等待。',
    clarifyNotificationTitle: 'Hermes 需要你的回复',
    clarifyNotificationBody: 'Agent 正在等待你的回答。',
    completionNotificationTitle: 'Hermes 已完成',
    completionNotificationBody: '{title} 已完成。',
    completionFailedNotificationTitle: 'Hermes 任务失败',
    completionFailedNotificationBody: '{title} 因错误结束。',
    clarifyExpiresIn: '剩余 {time}',
    clarifyExpired: '已超时',
    newCliChat: '新建 CLI',
    ...
    todoToolName: 'Todo',
    todoUpdated: 'Todo 已更新',
    todoList: 'Todo 列表',
    todoMoreItems: '还有 {count} 项',
    todoStatus: {
      pending: '待处理',
      in_progress: '进行中',
      completed: '已完成',
  ...
  models: {
    ...
    geminiLoginTitle: 'Google Gemini OAuth 登录',
    geminiWaiting: '请在打开的 Google 页面完成授权。授权完成后窗口会自动关闭。',
    geminiOpenLink: '打开 Google 授权页',
    geminiCopyLink: '复制授权链接',
    geminiApproved: '登录成功！',
    geminiExpired: '授权链接已过期，请重试。',
    customBadge: '自定义',
    previewBadge: '预览',
    disabledBadge: '不可用',
  ...
  settings: {
    ...
    display: {
      ...
      showToolMascotDesktop: '显示桌面工具角色',
      showToolMascotDesktopHint: '在桌面端实时工具调用旁显示角色',
      showToolMascotMobile: '显示移动端工具角色',
      showToolMascotMobileHint: '在移动端实时工具调用旁显示角色',
      showDrawerRainbow: '显示抽屉彩虹光效',
      showDrawerRainbowHint: '在抽屉按钮周围显示动态彩虹光效',
      pinRightDrawer: '固定右侧抽屉',
      pinRightDrawerHint: '在桌面端将右侧抽屉保持为始终可见的固定侧栏',
      autoOpenPatchDrawer: '自动展开 patch 详情',
      autoOpenPatchDrawerHint: 'patch 工具完成后，在实时工具记录中自动展开 diff/详情',
      showWorkspaceFileTree: 'Workspace 文件树',
      showWorkspaceFileTreeHint: '显示 Workspace 抽屉内左侧的文件树区域',
      ...
      browserNotifyOnComplete: '完成时浏览器通知',
      browserNotifyOnCompleteHint: '聊天运行结束时显示浏览器/桌面通知',
      browserNotifyOnCompleteDenied: '浏览器通知已被阻止。请先在浏览器或系统设置中允许。',
      ...
      terminalFontSizeHint: '调整终端文字大小',
      terminalFontFamily: '终端字体',
      terminalFontFamilyHint: '终端文字使用的 CSS font-family；留空则使用默认值',
  ...
  githubPreview: {
    ...
    path: "预览路径",
    webuiHome: "预览数据目录",
    activeVersion: "当前已应用版本",
    activePath: "已应用路径",
    activeUpdatedAt: "应用时间",
    currentTag: "当前 Tag",
    repoReady: "仓库就绪",
    dependencies: "依赖已安装",
    running: "运行状态",
  ...
  terminal: {
    ...
    mobileShortcutBar: '移动端终端辅助键',
    hideMobileShortcutBar: '隐藏移动端终端辅助键',
    showMobileShortcutBar: '显示移动端终端辅助键',
  ...
  changelog: {
    ...
    new_0_6_14_1: '官网和文档完成更新：重设计落地页、强制浅色展示，并新增 Hermes Studio 客户端手册',
    new_0_6_14_2: '完成通知现在可在桌面壳和支持的浏览器中提示任务已结束',
    new_0_6_14_3: '桌面端新增自定义标题栏、启动闪屏、更宽的授权抽屉、居中的加载状态，并修复 Linux 窗口控制按钮',
    new_0_6_14_4: 'Workspace 文件夹增加直接操作，文件和目录在界面里更容易打开、管理和使用',
    new_0_6_14_5: 'Profile 与运行时启动更稳定：拒绝保留名重命名、修复 Linux deb 启动路径、移除旧 gateway 清理逻辑，并减少 Coding Agent 恢复时不必要的 bridge 检查',
    new_0_6_14_6: '群聊身份在换浏览器后更可靠，agent 和成员名称会跟随账号/Profile 状态保持一致',
    new_0_6_14_7: '静态资源压缩处理已修复，打包 Web UI 文件交付更精简也更安全',
    new_0_6_14_8: '设备配对更安全：启动时生成配对码，请求进入审批前需要校验，频繁错误会被限制，同时保留可信局域网发现逻辑',
    new_0_6_14_9: '桌面端 Claude Code 检测会读取用户 shell PATH 和常见包管理器目录，macOS 与 Linux 上更容易找到已安装的 coding agent',
    new_0_6_14_10: 'Hermes 写入门禁覆盖记忆和技能写入，支持待审核列表、bridge 模块拆分、本地化授权界面，并改善桌面启动体验',
