export default {
  ...
  settings: {
    ...
    display: {
      ...
      fileIconThemeHint: '选择工作区、附件和文件夹选择器中的文件图标样式',
      fileIconThemeColor: '彩色',
  ...
  changelog: {
    ...
    new_0_6_21_7: '单聊、群聊和工作流顶部栏对齐更一致；小方盒页面改为售罄状态；BSL 授权范围更清晰；补充 /learn 接入规划，并移除废弃 Hermes proxy 代码',
    ...
    new_0_6_20_6: 'ESP32 和小方盒细节优化：更新教程链接，调整浅色背景下的小方盒徽标，并修复 Windows 上流动效果不显示的问题',
