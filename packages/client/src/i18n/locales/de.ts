...
jobTriggered: 'Job ausgelost',
  ...
  settings: {
    ...
    display: {
      ...
      fileIconTheme: 'Dateisymbol-Theme',
      fileIconThemeHint: 'Wähle den Stil für Dateisymbole in Arbeitsbereich, Anhängen und Ordnerauswahl',
      fileIconThemeColor: 'Farbe',
      fileIconThemeMono: 'Mono',
      fileIconThemeTerminal: 'Terminal',
      showTerminalSessionList: 'Terminal-Sitzungsliste',
      showTerminalSessionListHint: 'Zeigt die linke Sitzungsliste als Desktop-Seitenleiste. Mobil bleibt der Sitzungen-Drawer-Button aktiv.',
  ...
  usage: {
    ...
    codingAgentBreakdown: 'Coding-Agent-Token',
  ...
  changelog: {
    ...
    new_0_6_18_2: 'Hermes Studio MCP ist in fokussierte api-, devices- und use-Toolsets aufgeteilt, mit neuen Session-, Modell-, Chat-Run- und Ops-Aktionen',
    ...
    new_0_6_18_6: 'Desktop- und Runtime-Setup sind sicherer mit Unicode-sicherer Windows-PATH-Registrierung, Hermes Agent 0.17.0 Runtime-Publishing, mobiler PWA-Metadata und mehreren Profile/Auth-Recovery-Fixes',
  ...
  artifacts: {
    ...
    openInArtifacts: 'In Artefakten öffnen',
    download: 'Herunterladen',
