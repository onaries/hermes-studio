export default {
  ...
  chat: {
    ...
    todoPanel: {
      title: 'Todo',
      subtitle: 'Alle Todo-Einträge aus dieser aktiven Anfrage.',
      total: 'Einträge',
      hide: 'Todo ausblenden',
      show: 'Todo anzeigen',
    },
    reasoningEffort: {
      tooltip: 'Denkaufwand',
    ...
    browserNotificationsEnable: 'Browser-Benachrichtigungen erlauben',
    browserNotificationsUnsupported: 'Browser-Benachrichtigungen werden hier nicht unterstützt.',
    browserNotificationsEnabled: 'Browser-Benachrichtigungen aktiviert.',
    approvalNotificationTitle: 'Hermes benötigt eine Freigabe',
    approvalNotificationBody: 'Eine Tool-Freigabe wartet.',
    clarifyNotificationTitle: 'Hermes benötigt deine Antwort',
    clarifyNotificationBody: 'Der Agent wartet auf deine Antwort.',
    completionNotificationTitle: 'Hermes ist fertig',
    completionNotificationBody: '{title} ist abgeschlossen.',
    completionFailedNotificationTitle: 'Hermes-Aufgabe fehlgeschlagen',
    completionFailedNotificationBody: '{title} endete mit einem Fehler.',
    clarifyExpiresIn: 'Läuft ab in {time}',
    clarifyExpired: 'Abgelaufen',
    ...
    terminalRunning: 'Terminal läuft · {elapsed}',
    toolSummary: {
      query: 'Query: {value}',
      path: 'Path: {value}',
      url: 'URL: {value}',
    ...
    toolAggregate: {
      ...
      elapsedDuration: 'Dauer {duration}',
...
jobTriggered: 'Job ausgelost',
  ...
  settings: {
    ...
    display: {
      ...
      showLiveTps: 'Live-TPS anzeigen',
      showLiveTpsHint: 'Zeigt beim Streaming die geschätzten Tokens pro Sekunde in der Chat-Eingabe an',
      showToolMascot: 'Tool-Maskottchen anzeigen',
      showToolMascotHint: 'Zeigt die Figur neben Live-Tool-Aufrufen an',
      showToolMascotDesktop: 'Desktop-Tool-Maskottchen anzeigen',
      showToolMascotDesktopHint: 'Zeigt die Figur neben Live-Tool-Aufrufen auf dem Desktop an',
      showToolMascotMobile: 'Mobiles Tool-Maskottchen anzeigen',
      showToolMascotMobileHint: 'Zeigt die Figur neben Live-Tool-Aufrufen auf Mobilgeräten an',
      showDrawerRainbow: 'Regenbogenleuchten des Drawers anzeigen',
      showDrawerRainbowHint: 'Zeigt das animierte Regenbogenleuchten um die Drawer-Schaltfläche an',
      pinRightDrawer: 'Rechten Drawer anheften',
      pinRightDrawerHint: 'Den rechten Drawer auf dem Desktop dauerhaft als Seitenleiste anzeigen',
      autoOpenPatchDrawer: 'Patch-Details nach Patch automatisch aufklappen',
      autoOpenPatchDrawerHint: 'Klappt die Patch-Details im Tool-Verlauf automatisch auf, wenn ein patch-Tool fertig ist',
      showWorkspaceFileTree: 'Workspace-Dateibaum',
      showWorkspaceFileTreeHint: 'Zeigt den linken Dateibaum im Workspace-Drawer an',
      showTerminalSessionList: 'Terminal-Sitzungsliste',
      showTerminalSessionListHint: 'Zeigt die linke Sitzungsliste im Terminal-Drawer an',
      inlineDiffs: 'Inline-Diffs',
      inlineDiffsHint: 'Codeanderungen inline anzeigen',
      bellOnComplete: 'Abschluss-Signalton',
      browserNotifyOnComplete: 'Browser-Hinweis bei Abschluss',
      browserNotifyOnCompleteHint: 'Browser-/Desktop-Benachrichtigung anzeigen, wenn ein Chat-Lauf endet',
      browserNotifyOnCompleteDenied: 'Browser-Benachrichtigungen sind blockiert. Erlaube sie zuerst im Browser oder Betriebssystem.',
      bellOnCompleteHint: 'Ton abspielen, wenn die KI fertig ist',
      mobileEnterToSend: 'Auf Mobilgeräten mit Enter senden',
      mobileEnterToSendHint: 'Wenn deaktiviert, fügt Enter auf mobilen Tastaturen nur einen Zeilenumbruch ein; zum Senden die Schaltfläche verwenden.',
      terminalFontSize: 'Terminal-Schriftgröße',
      terminalFontSizeHint: 'Terminal-Textgröße anpassen',
      terminalFontFamily: 'Terminal-Schriftart',
      terminalFontFamilyHint: 'CSS font-family für Terminal-Text; leer lassen für den Standardwert',
  ...
  githubPreview: {
    ...
    activeVersion: "Aktiv angewendete Version",
    activePath: "Angewendeter Pfad",
    activeUpdatedAt: "Angewendet am",
    ...
    applySuccess: "Internes Update installiert; Neustart",
  ...
  terminal: {
    ...
    mobileShortcutBar: 'Mobile Terminal-Zusatztasten',
    hideMobileShortcutBar: 'Mobile Terminal-Zusatztasten ausblenden',
    showMobileShortcutBar: 'Mobile Terminal-Zusatztasten anzeigen',
  ...
  changelog: {
    ...
    new_0_6_14_4: 'Workspace-Ordner haben direkte Aktionen, sodass Dateien und Verzeichnisse in der UI leichter geoeffnet, verwaltet und genutzt werden koennen',
    new_0_6_14_5: 'Profile- und Runtime-Start sind stabiler mit Schutz vor reservierten Profilnamen, Linux-deb-Startfixes, entfernter alter Gateway-Bereinigung und weniger unnoetigen Bridge-Checks beim Fortsetzen von Coding Agents',
    new_0_6_14_6: 'Gruppenchat-Identitaeten bleiben browseruebergreifend verlaesslicher, sodass Agent- und Mitgliedsnamen mit Account/Profile-Zustand synchron bleiben',
    new_0_6_14_7: 'Die Auslieferung statischer Assets ist schlanker und sicherer, nachdem die Komprimierung fuer paketierte Web-UI-Dateien korrigiert wurde',
    new_0_6_14_8: 'Geraetekopplung ist sicherer mit Start-Pairing-Code, Freigabe vor Anfragen, Anfrage-Drosselung und unveraenderter LAN-Erkennung fuer vertrauenswuerdige lokale Abläufe',
    new_0_6_14_9: 'Desktop Claude Code Detection liest jetzt die User-Shell-PATH und gaengige Paketmanager-Pfade, damit installierte Coding Agents unter macOS und Linux verlaesslicher gefunden werden',
    new_0_6_14_10: 'Hermes Write-Gate deckt jetzt Memory- und Skill-Writes mit Review ausstehender Freigaben, Bridge-Modulaufteilung, lokalisierter Approval-UI und verbessertem Desktop-Start ab',
  ...
  artifacts: {
    ...
    hideList: 'Artefaktliste ausblenden',
    showList: 'Artefaktliste anzeigen',
    download: 'Herunterladen',
