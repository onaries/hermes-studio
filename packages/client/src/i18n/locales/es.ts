export default {
  ...
  drawer: {
    ...
    todo: {
      ...
      subtitle: 'Solo tareas en curso de esta sesión de chat.',
      total: 'En curso',
      lastUpdated: 'Última actualización {time}',
      emptyTitle: 'No hay tareas en curso',
      emptyDescription: 'Cuando Hermes marque una tarea como en curso, aparecerá aquí.',
    },
  },
  ...
  chat: {
    ...
    outlineGoTop: 'Ir arriba',
    outlineGoBottom: 'Ir abajo',
    ...
    todoPanel: {
      title: 'Todo',
      subtitle: 'Todos los elementos Todo de esta solicitud activa.',
      total: 'Elementos',
      hide: 'Ocultar Todo',
      show: 'Mostrar Todo',
    },
    ...
    sessionNeedsApproval: 'Approval',
    sessionNeedsClarify: 'Needs answer',
    ...
    browserNotificationsEnable: 'Permitir alertas del navegador',
    browserNotificationsUnsupported: 'Las notificaciones del navegador no son compatibles aquí.',
    browserNotificationsEnabled: 'Alertas del navegador activadas.',
    approvalNotificationTitle: 'Hermes necesita aprobación',
    approvalNotificationBody: 'Hay una aprobación de herramienta pendiente.',
    clarifyNotificationTitle: 'Hermes necesita tu respuesta',
    clarifyNotificationBody: 'El agente espera tu respuesta.',
    completionNotificationTitle: 'Hermes terminó',
    completionNotificationBody: '{title} ha terminado.',
    completionFailedNotificationTitle: 'La tarea de Hermes falló',
    completionFailedNotificationBody: '{title} terminó con un error.',
    clarifyExpiresIn: 'Expira en {time}',
    clarifyExpired: 'Expirado',
    ...
    executionDuration: 'Tiempo de ejecución',
    terminalRunning: 'Terminal en ejecución · {elapsed}',
    toolSummary: {
      query: 'Query: {value}',
      path: 'Path: {value}',
      url: 'URL: {value}',
    ...
    toolAggregate: {
      ...
      expand: 'Show tool details',
      ranCommandsOne: 'Ran 1 command',
      ranCommandsMany: 'Ran {count} commands',
      searchedWorkspaceOne: 'searched workspace 1 time',
      searchedWorkspaceMany: 'searched workspace {count} times',
      checkedWebOne: 'checked the web',
      checkedWebMany: 'checked the web {count} times',
      listedFilesOne: 'listed files',
      listedFilesMany: 'listed files {count} times',
      readFilesOne: 'read 1 file',
      readFilesMany: 'read {count} files',
      editedFilesOne: 'edited 1 file',
      editedFilesMany: 'edited {count} files',
      loadedSkillsOne: 'loaded 1 skill',
      loadedSkillsMany: 'loaded {count} skills',
      updatedTodosOne: 'updated Todo',
      updatedTodosMany: 'updated Todo {count} times',
      ranCodeOne: 'ran code',
      ranCodeMany: 'ran code {count} times',
      delegatedTasksOne: 'delegated 1 task',
      delegatedTasksMany: 'delegated {count} tasks',
      usedBrowserOne: 'used browser',
      usedBrowserMany: 'used browser {count} times',
      usedComputerOne: 'used computer',
    ...
    todoToolName: 'Todo',
    todoUpdated: 'Todo actualizado',
    todoList: 'Lista Todo',
    todoMoreItems: '+{count} más',
    todoStatus: {
      pending: 'Pendiente',
    ...
    btwLabel: 'Pregunta lateral',
    btwDismiss: 'Cerrar pregunta lateral (Esc)',
...
jobTriggered: 'Job ejecutado',
  ...
  settings: {
    ...
    display: {
      ...
      showLiveTps: 'Mostrar TPS en vivo',
      showLiveTpsHint: 'Muestra los tokens por segundo estimados en la entrada de chat durante el streaming',
      showToolMascot: 'Mostrar mascota de herramientas',
      showToolMascotHint: 'Muestra el personaje junto a las llamadas de herramientas en vivo',
      showToolMascotDesktop: 'Mostrar mascota de herramientas en escritorio',
      showToolMascotDesktopHint: 'Muestra el personaje junto a las llamadas de herramientas en vivo en escritorio',
      showToolMascotMobile: 'Mostrar mascota de herramientas en móvil',
      showToolMascotMobileHint: 'Muestra el personaje junto a las llamadas de herramientas en vivo en móvil',
      showDrawerRainbow: 'Mostrar brillo arcoiris del panel lateral',
      showDrawerRainbowHint: 'Muestra el brillo arcoiris animado alrededor del boton del panel lateral',
      pinRightDrawer: 'Fijar panel derecho',
      pinRightDrawerHint: 'Mantener el panel derecho visible como una barra lateral fija en escritorio',
      autoOpenPatchDrawer: 'Expandir detalles del patch automáticamente',
      autoOpenPatchDrawerHint: 'Cuando termina una herramienta patch, expande su diff/detalles en la traza de herramientas en vivo',
      showWorkspaceFileTree: 'Árbol de archivos de Workspace',
      showWorkspaceFileTreeHint: 'Muestra el árbol de archivos izquierdo dentro del panel Workspace',
      showTerminalSessionList: 'Lista de sesiones de Terminal',
      showTerminalSessionListHint: 'Muestra la lista de sesiones izquierda dentro del panel Terminal',
      inlineDiffs: 'Diffs en linea',
      inlineDiffsHint: 'Mostrar cambios de codigo en linea',
      bellOnComplete: 'Sonido de finalizacion',
      browserNotifyOnComplete: 'Alerta del navegador al terminar',
      browserNotifyOnCompleteHint: 'Mostrar una notificación del navegador/escritorio cuando termine la ejecución del chat',
      browserNotifyOnCompleteDenied: 'Las notificaciones del navegador están bloqueadas. Permítelas en el navegador o el sistema operativo.',
      bellOnCompleteHint: 'Reproducir un sonido cuando la IA termina',
      mobileEnterToSend: 'Enviar con Enter en móvil',
      mobileEnterToSendHint: 'Si está desactivado, Enter en teclados móviles solo inserta una línea nueva; usa el botón de enviar.',
      terminalFontSize: 'Tamaño de fuente del terminal',
      terminalFontSizeHint: 'Ajusta el tamaño del texto del terminal',
      terminalFontFamily: 'Fuente del terminal',
      terminalFontFamilyHint: 'CSS font-family para el texto del terminal; vacía para usar el valor predeterminado',
  ...
  githubPreview: {
    ...
    activeVersion: "Versión aplicada",
    activePath: "Ruta aplicada",
    activeUpdatedAt: "Aplicado el",
    ...
    applySuccess: "Actualizacion interna instalada; reiniciando",
  ...
  terminal: {
    ...
    mobileShortcutBar: 'Teclas auxiliares del terminal móvil',
    hideMobileShortcutBar: 'Ocultar teclas auxiliares del terminal móvil',
    showMobileShortcutBar: 'Mostrar teclas auxiliares del terminal móvil',
  ...
  changelog: {
    ...
    new_0_6_14_4: 'Las carpetas de Workspace ganan acciones directas para abrir, gestionar y usar archivos y directorios con menos pasos',
    new_0_6_14_5: 'El inicio de Profile y runtime es mas estable con rechazo de nombres reservados, fixes de lanzamiento deb en Linux, eliminacion de limpieza legacy de gateway y menos chequeos bridge al reanudar Coding Agents',
    new_0_6_14_6: 'La identidad del chat grupal es mas fiable entre navegadores, manteniendo nombres de agentes y miembros alineados con cuenta/Profile',
    new_0_6_14_7: 'La entrega de assets estaticos es mas ligera y segura tras corregir la compresion de archivos Web UI empaquetados',
    new_0_6_14_8: 'El emparejamiento de dispositivos es mas seguro con codigo por inicio, solicitudes con aprobacion, limitacion de errores y logica LAN preservada para flujos locales de confianza',
    new_0_6_14_9: 'La deteccion de Claude Code en escritorio lee el PATH del shell del usuario y ubicaciones comunes de gestores de paquetes para encontrar coding agents instalados en macOS y Linux',
    new_0_6_14_10: 'Hermes write gate cubre escrituras de memoria y skills con revision pendiente, division de modulos bridge, UI de aprobacion localizada y mejoras de arranque de escritorio',
  ...
  artifacts: {
    ...
    scrollToTop: 'Arriba',
    hideList: 'Ocultar lista de artefactos',
    showList: 'Mostrar lista de artefactos',
    download: 'Descargar',
    remove: 'Eliminar artefacto',
    emptyTitle: 'Aún no hay artefactos',
    emptyDescription: 'Abre un archivo Markdown o de texto generado desde el chat para previsualizarlo aquí.',
    loadFailed: 'No se pudo cargar el artefacto',
    unsupported: 'Este archivo no se puede previsualizar. Descárgalo para abrirlo localmente.',
  },
