...
jobTriggered: 'Job ejecutado',
  ...
  // Registro de cambios
  changelog: {
    new_0_6_11_1: 'El descubrimiento de dispositivos LAN ahora incluye aprobaciones de emparejamiento, historial de solicitudes, manejo de duplicados, sincronizacion de estado y limpieza al revocar acceso',
    new_0_6_11_2: 'El acceso LAN peer esta disponible mediante MCP con inicio MCP integrado, command shims, sockets peer con reconexion, lista de conexiones locales y sesiones de terminal limitadas',
    new_0_6_11_3: 'La sintesis TTS backend unificada y los ajustes de clonacion de voz MiMo ya estan disponibles, con reproduccion antes de guardar',
    new_0_6_11_4: 'Los ajustes de autostart de Gateway ahora exponen filtrado por Profile con controles multi-select, comportamiento whitelist y pruebas de seleccion de Profile de inicio',
    new_0_6_11_5: 'El scroll y las animaciones del chat son mas estables con ajustes de bottom-follow, scroll inicial al final, scroll lock y manejo de fade con reduced-motion',
    new_0_6_11_6: 'Agent Bridge y runtime flows son mas fiables con manejo de abort timeout, guards de inicio al reanudar, memoria de aprobacion execute-code, recuperacion de Windows Gateway y fixes del proxy terminal dev',
    new_0_6_11_7: 'La seguridad mejora con hardening de Web UI origin policy, security headers y guards de acceso loopback para server token',
    new_0_6_11_8: 'Group chat y renderizado de tool output son mas estables con rejoin tras reconnect, preservacion de reasoning/tool boundaries, tool payload rendering mas seguro y mejor vista diff',
    new_0_6_11_9: 'Skills y Workspace soportan external skill directories, refresh tras import/delete, agrupacion por sourcePath, texto localizado del selector de carpetas e iconos moviles de acciones',
    new_0_6_11_10: 'Se pulieron layout de dispositivos, titulos de sesion, titulos de browser tab, Kanban parent task IDs y texto de atribucion OpenRouter',
