...
jobTriggered: 'Job ejecutado',
  ...
  changelog: {
    ...
    new_0_6_12_10: 'Otras mejoras del frontend incluyen respaldo para emparejamiento remoto, preset Atlas Cloud, textos de barra lateral mas claros, identidad de cierre de sesion mas precisa y eliminacion del ajuste Busy Input sin conexion',
