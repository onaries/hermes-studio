...
jobTriggered: 'Job ejecutado',
  ...
  settings: {
    ...
    display: {
      ...
      fileIconTheme: 'Tema de iconos de archivo',
      fileIconThemeHint: 'Elige el estilo de iconos en el espacio de trabajo, adjuntos y selector de carpetas',
      fileIconThemeColor: 'Color',
      fileIconThemeMono: 'Mono',
      fileIconThemeTerminal: 'Terminal',
      showTerminalSessionList: 'Lista de sesiones de Terminal',
      showTerminalSessionListHint: 'Muestra la lista lateral de sesiones en escritorio. En móvil se sigue usando el botón de sesiones.',
  ...
  usage: {
    ...
    codingAgentBreakdown: 'Tokens del agente de código',
  ...
  artifacts: {
    ...
    openInArtifacts: 'Abrir en artefactos',
    download: 'Descargar',
