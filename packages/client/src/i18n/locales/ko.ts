export default {
  ...
  chat: {
    ...
    clarifySubmit: '답장',
    clarifyDismiss: '무시',
    browserNotificationsEnable: '브라우저 알림 허용',
    browserNotificationsUnsupported: '이 환경에서는 브라우저 알림을 지원하지 않습니다.',
    browserNotificationsEnabled: '브라우저 알림을 켰습니다.',
    approvalNotificationTitle: 'Hermes 승인 필요',
    approvalNotificationBody: '도구 실행 승인이 대기 중입니다.',
    clarifyNotificationTitle: 'Hermes 답변 필요',
    clarifyNotificationBody: '에이전트가 답변을 기다리고 있습니다.',
    completionNotificationTitle: 'Hermes 작업 완료',
    completionNotificationBody: '{title} 작업이 끝났습니다.',
    completionFailedNotificationTitle: 'Hermes 작업 실패',
    completionFailedNotificationBody: '{title} 작업이 오류로 종료되었습니다.',
    clarifyExpiresIn: '{time} 후 만료',
    clarifyExpired: '만료됨',
    ...
    toolAggregate: {
      collapse: '도구 세부 내역 접기',
      expand: '도구 세부 내역 보기',
      ranCommandsOne: '명령 1개 실행',
      ranCommandsMany: '명령 {count}개 실행',
      searchedWorkspaceOne: '워크스페이스 1회 검색',
      searchedWorkspaceMany: '워크스페이스 {count}회 검색',
      checkedWebOne: '웹 확인',
      checkedWebMany: '웹 {count}회 확인',
      listedFilesOne: '파일 나열',
      listedFilesMany: '파일 {count}회 나열',
      readFilesOne: '파일 1개 읽음',
      readFilesMany: '파일 {count}개 읽음',
      editedFilesOne: '파일 1개 수정',
      editedFilesMany: '파일 {count}개 수정',
      loadedSkillsOne: '스킬 1개 로드',
      loadedSkillsMany: '스킬 {count}개 로드',
      updatedTodosOne: 'Todo 업데이트',
      updatedTodosMany: 'Todo {count}회 업데이트',
      ranCodeOne: '코드 실행',
      ranCodeMany: '코드 {count}회 실행',
      delegatedTasksOne: '작업 1개 위임',
      delegatedTasksMany: '작업 {count}개 위임',
      usedBrowserOne: '브라우저 사용',
      usedBrowserMany: '브라우저 {count}회 사용',
      usedComputerOne: '컴퓨터 제어 사용',
    ...
    todoToolName: 'Todo',
    todoUpdated: 'Todo 업데이트',
    todoList: 'Todo 목록',
    todoMoreItems: '+{count}개 더',
    todoStatus: {
      pending: '대기',
      in_progress: '진행 중',
      completed: '완료',
  ...
  settings: {
    ...
    display: {
      ...
      showToolMascotDesktop: '데스크톱 툴 캐릭터 표시',
      showToolMascotDesktopHint: '데스크톱에서 실시간 툴 호출 왼쪽의 캐릭터를 표시합니다',
      showToolMascotMobile: '모바일 툴 캐릭터 표시',
      ...
      browserNotifyOnComplete: '완료 브라우저 알림',
      browserNotifyOnCompleteHint: '채팅 작업이 끝나면 브라우저/데스크톱 알림을 표시',
      browserNotifyOnCompleteDenied: '브라우저 알림이 차단되어 있습니다. 브라우저 또는 OS 설정에서 먼저 허용하세요.',
      ...
      terminalFontSize: '터미널 글씨 크기',
      terminalFontSizeHint: '터미널 글자 크기를 조절합니다',
      terminalFontFamily: '터미널 폰트',
      terminalFontFamilyHint: '터미널 텍스트에 사용할 CSS font-family입니다. 비우면 기본값을 사용합니다',
  ...
  githubPreview: {
    ...
    activeVersion: "현재 적용된 버전",
    activePath: "적용된 경로",
    activeUpdatedAt: "적용 시각",
    currentTag: "현재 Tag",
    repoReady: "저장소 준비됨",
    ...
    applySuccess: "내부 업데이트를 설치했습니다. 재시작합니다",
  ...
  terminal: {
    ...
    mobileShortcutBar: '모바일 터미널 보조키',
    hideMobileShortcutBar: '모바일 터미널 보조키 숨기기',
    showMobileShortcutBar: '모바일 터미널 보조키 보이기',
  ...
  changelog: {
    ...
    new_0_6_14_1: '웹사이트와 문서를 새로 정리해 랜딩 페이지를 다시 디자인하고, 라이트 테마 표시를 고정하며, Hermes Studio 클라이언트 매뉴얼을 추가했습니다',
    new_0_6_14_2: '완료 알림이 데스크톱 셸과 지원 브라우저에서 실행 완료를 알려줄 수 있습니다',
    new_0_6_14_3: '데스크톱에 사용자 지정 제목 표시줄, 더 깔끔한 시작 스플래시, 더 넓은 승인 드로어, 중앙 로딩 상태를 추가하고 Linux 창 제어 버튼을 수정했습니다',
    new_0_6_14_4: 'Workspace 폴더에 직접 작업을 추가해 UI에서 파일과 디렉터리를 더 쉽게 열고 관리하고 사용할 수 있습니다',
    new_0_6_14_5: 'Profile 및 runtime 시작이 더 안정적입니다. 예약된 이름 rename 거부, Linux deb 시작 경로 수정, legacy gateway cleanup 제거, Coding Agent 재개 시 불필요한 bridge check 감소를 포함합니다',
    new_0_6_14_6: '브라우저를 바꿔도 그룹 채팅 identity가 더 안정적으로 유지되어 agent와 멤버 이름이 계정/Profile 상태와 일치합니다',
    new_0_6_14_7: '패키징된 Web UI 파일의 압축 처리를 수정해 static asset 전달이 더 가볍고 안전해졌습니다',
    new_0_6_14_8: '기기 페어링은 시작 시 pairing code, 승인 전 요청 검증, 요청 제한으로 더 안전해졌고 신뢰할 수 있는 로컬 흐름을 위한 LAN discovery는 유지됩니다',
    new_0_6_14_9: '데스크톱 Claude Code 감지가 사용자 shell PATH와 일반적인 패키지 관리자 경로를 읽어 macOS와 Linux에서 설치된 coding agent를 더 안정적으로 찾습니다',
    new_0_6_14_10: 'Hermes write gate가 memory와 skill 쓰기, 대기 승인 검토, bridge 모듈 분리, 현지화된 승인 UI, 개선된 데스크톱 시작 동작을 지원합니다',
