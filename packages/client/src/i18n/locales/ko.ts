export default {
  ...
  // 변경 이력
  changelog: {
    new_0_6_11_1: 'LAN device discovery 에 pairing approvals, request history, duplicate request handling, status sync, device access revoke 시 cleanup 이 추가되었습니다',
    new_0_6_11_2: 'LAN peer access 는 MCP 에서 사용할 수 있으며 bundled MCP startup, command shims, reconnecting peer sockets, local connection listing, terminal session caps 를 지원합니다',
    new_0_6_11_3: 'Unified backend TTS synthesis 와 MiMo voice cloning settings 를 사용할 수 있고 저장 전 playback 을 지원합니다',
    new_0_6_11_4: 'Gateway autostart settings 가 Profile multi-select filtering, whitelist behavior, startup profile selection tests 를 지원합니다',
    new_0_6_11_5: 'Chat scrolling 과 motion 이 bottom-follow tuning, initial bottom scroll fixes, scroll lock updates, reduced-motion fade handling 으로 더 안정적입니다',
    new_0_6_11_6: 'Agent Bridge 와 runtime flows 가 abort timeout handling, resume startup guards, execute-code approval memory, Windows Gateway recovery, dev terminal proxy fixes 로 더 안정적입니다',
    new_0_6_11_7: 'Web UI origin policy, security headers, server-token loopback access guards 로 security 가 강화되었습니다',
    new_0_6_11_8: 'Group chat 과 tool output rendering 이 reconnect 후 room rejoin, reasoning/tool boundaries 보존, 더 안전한 tool payload rendering, 개선된 diff display 로 안정화되었습니다',
    new_0_6_11_9: 'Skills 와 Workspace flows 가 external skill directories, import/delete refresh, sourcePath grouping, localized folder picker text, mobile skill action icons 를 지원합니다',
    new_0_6_11_10: 'Device layout, session titles, browser tab titles, Kanban parent task IDs, OpenRouter attribution text 가 개선되었습니다',
