export default {
  ...
  settings: {
    ...
    display: {
      ...
      fileIconThemeHint: '작업 공간, 첨부 파일, 폴더 선택 화면의 파일 아이콘 스타일을 고릅니다',
      fileIconThemeColor: '컬러',
  ...
  changelog: {
    ...
    new_0_6_18_2: 'Hermes Studio MCP가 api, devices, use toolset으로 나뉘고 session, model, chat-run, ops 작업이 추가되었습니다',
