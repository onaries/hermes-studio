export default {
  ...
  chat: {
    ...
    browserNotificationsEnable: 'Permitir alertas do navegador',
    browserNotificationsUnsupported: 'Notificações do navegador não são suportadas aqui.',
    browserNotificationsEnabled: 'Alertas do navegador ativados.',
    approvalNotificationTitle: 'Hermes precisa de aprovação',
    approvalNotificationBody: 'Uma aprovação de ferramenta está aguardando.',
    clarifyNotificationTitle: 'Hermes precisa da sua resposta',
    clarifyNotificationBody: 'O agente está aguardando sua resposta.',
    completionNotificationTitle: 'Hermes terminou',
    completionNotificationBody: '{title} foi concluído.',
    completionFailedNotificationTitle: 'Tarefa do Hermes falhou',
    completionFailedNotificationBody: '{title} terminou com erro.',
    clarifyExpiresIn: 'Expira em {time}',
    ...
    result: 'Resultado',
    patchChanges: 'Alterações do patch',
    truncated: '... (truncado)',
    unchangedLines: '{count} linhas inalteradas',
    executionDuration: 'Tempo de execução',
    toolSummary: {
      query: 'Query: {value}',
      path: 'Path: {value}',
      url: 'URL: {value}',
    ...
    toolAggregate: {
      ...
      elapsedDuration: 'Duração {duration}',
    ...
    todoToolName: 'Todo',
    todoUpdated: 'Todo atualizado',
    todoList: 'Lista Todo',
    todoMoreItems: '+{count} mais',
    todoStatus: {
      pending: 'Pendente',
    ...
    btwLabel: 'Pergunta lateral',
    btwDismiss: 'Fechar pergunta lateral (Esc)',
...
jobTriggered: 'Job acionado',
  ...
  settings: {
    ...
    display: {
      ...
      showLiveTps: 'Mostrar TPS ao vivo',
      showLiveTpsHint: 'Mostra os tokens por segundo estimados na entrada do chat durante o streaming',
      showToolMascot: 'Mostrar mascote das ferramentas',
      showToolMascotHint: 'Mostra o personagem ao lado das chamadas de ferramentas ao vivo',
      showToolMascotDesktop: 'Mostrar mascote das ferramentas no desktop',
      showToolMascotDesktopHint: 'Mostra o personagem ao lado das chamadas de ferramentas ao vivo no desktop',
      showToolMascotMobile: 'Mostrar mascote das ferramentas no celular',
      showToolMascotMobileHint: 'Mostra o personagem ao lado das chamadas de ferramentas ao vivo no celular',
      showDrawerRainbow: 'Mostrar brilho arco-iris do drawer',
      showDrawerRainbowHint: 'Mostra o brilho arco-iris animado ao redor do botao do drawer',
      pinRightDrawer: 'Fixar gaveta direita',
      pinRightDrawerHint: 'Manter a gaveta direita visível como painel lateral fixo no desktop',
      autoOpenPatchDrawer: 'Expandir detalhes do patch automaticamente',
      autoOpenPatchDrawerHint: 'Quando a ferramenta patch terminar, expande o diff/detalhes no rastreamento de ferramentas ao vivo',
      showWorkspaceFileTree: 'Árvore de arquivos do Workspace',
      showWorkspaceFileTreeHint: 'Mostra a árvore de arquivos à esquerda na gaveta Workspace',
      fileIconTheme: 'Tema de ícones de arquivo',
      fileIconThemeHint: 'Escolha o estilo dos ícones no workspace, anexos e seletor de pastas',
      fileIconThemeColor: 'Colorido',
      fileIconThemeMono: 'Mono',
      fileIconThemeTerminal: 'Terminal',
      showTerminalSessionList: 'Lista de sessões do Terminal',
      showTerminalSessionListHint: 'Mostra a lista lateral de sessões no desktop. No celular, o botão de sessões continua sendo usado.',
      inlineDiffs: 'Diffs em linha',
      inlineDiffsHint: 'Mostrar alteracoes de codigo em linha',
      bellOnComplete: 'Som de conclusao',
      browserNotifyOnComplete: 'Alerta do navegador ao concluir',
      browserNotifyOnCompleteHint: 'Mostrar uma notificação do navegador/desktop quando a execução do chat terminar',
      browserNotifyOnCompleteDenied: 'As notificações do navegador estão bloqueadas. Permita-as nas configurações do navegador ou do SO.',
      bellOnCompleteHint: 'Tocar som quando a IA terminar',
      mobileEnterToSend: 'Enviar com Enter no celular',
      mobileEnterToSendHint: 'Quando desativado, Enter em teclados móveis apenas quebra a linha; use o botão de envio.',
      terminalFontSize: 'Tamanho da fonte do terminal',
      terminalFontSizeHint: 'Ajuste o tamanho do texto do terminal',
      terminalFontFamily: 'Fonte do terminal',
      terminalFontFamilyHint: 'CSS font-family para o texto do terminal; deixe vazio para usar o padrão',
  ...
  githubPreview: {
    ...
    activeVersion: "Versão aplicada",
    activePath: "Caminho aplicado",
    activeUpdatedAt: "Aplicado em",
    ...
    applySuccess: "Atualizacao interna instalada; reiniciando",
  ...
  terminal: {
    ...
    mobileShortcutBar: 'Teclas de atalho do terminal móvel',
    hideMobileShortcutBar: 'Ocultar teclas de atalho do terminal móvel',
    showMobileShortcutBar: 'Mostrar teclas de atalho do terminal móvel',
  ...
  usage: {
    ...
    codingAgentBreakdown: 'Tokens do agente de código',
  ...
  changelog: {
    ...
    new_0_6_21_7: 'Headers de chat, group chat e workflow estao mais alinhados; Xiao Fang He mostra sold out; o escopo BSL ficou mais claro; o plano /learn foi documentado; o proxy Hermes legado foi removido',
    ...
    new_0_6_18_6: 'Desktop e runtime setup ficaram mais seguros com registro Unicode-safe do PATH no Windows, suporte a publicar runtime Hermes Agent 0.17.0, metadata PWA movel e varias correcoes de profile/auth recovery',
  ...
  artifacts: {
    ...
    scrollToTop: 'Topo',
    hideList: 'Ocultar lista de artefatos',
    showList: 'Mostrar lista de artefatos',
    openInArtifacts: 'Abrir nos artefatos',
    download: 'Baixar',
