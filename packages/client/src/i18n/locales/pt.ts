...
jobTriggered: 'Job acionado',
  ...
  changelog: {
    ...
    new_0_6_12_10: 'Outras melhorias de frontend incluem fallback para pareamento remoto, preset Atlas Cloud, textos de sidebar mais claros, identidade de logout refinada e remocao da configuracao Busy Input sem ligacao',
