...
jobTriggered: 'Job acionado',
  ...
  changelog: {
    new_0_6_11_1: 'A descoberta de dispositivos LAN agora inclui aprovacoes de pairing, historico de requests, tratamento de duplicados, sync de status e limpeza ao revogar acesso',
    new_0_6_11_2: 'O acesso LAN peer esta disponivel via MCP com startup MCP integrado, command shims, peer sockets com reconexao, lista de conexoes locais e sessoes de terminal limitadas',
    new_0_6_11_3: 'A sintese TTS backend unificada e as configuracoes de clonagem de voz MiMo estao disponiveis, com playback antes de salvar',
    new_0_6_11_4: 'As configuracoes Gateway autostart agora exibem filtragem por Profile com controles multi-select, comportamento whitelist e testes de selecao de Profile inicial',
    new_0_6_11_5: 'O scroll e as animacoes do chat estao mais estaveis com bottom-follow tuning, initial bottom scroll fixes, scroll lock updates e tratamento de fade reduced-motion',
    new_0_6_11_6: 'Agent Bridge e runtime flows estao mais confiaveis com abort timeout handling, resume startup guards, memoria de aprovacao execute-code, recuperacao Windows Gateway e fixes do proxy terminal dev',
    new_0_6_11_7: 'A seguranca foi reforcada com Web UI origin policy, security headers e guards de acesso loopback para server token',
    new_0_6_11_8: 'Group chat e renderizacao de tool output estao mais estaveis com rejoin apos reconnect, preservacao de reasoning/tool boundaries, tool payload rendering mais seguro e melhor diff display',
    new_0_6_11_9: 'Skills e Workspace agora suportam external skill directories, refresh apos import/delete, agrupamento por sourcePath, texto localizado do folder picker e icones moveis de acoes',
    new_0_6_11_10: 'Layout de dispositivos, titulos de sessao, titulos de browser tab, Kanban parent task IDs e texto de atribuicao OpenRouter receberam polimento de UI',
