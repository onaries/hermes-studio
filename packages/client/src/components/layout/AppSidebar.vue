    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-group">
        ...
        <div v-show="!isGroupCollapsed('conversation')" class="nav-group-items">
          ...
          <RouteLinkItem class="nav-item" :to="{ name: 'hermes.globalAgent' }" :active="isNavActive('hermes.globalAgent', 'hermes.globalAgentSession')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="sidebar-footer">
      ...
      <div class="version-info">
        <div class="version-links">
          <a class="github-link" href="https://github.com/EKKOLearnAI/hermes-studio" target="_blank" rel="noopener noreferrer" title="GitHub">
