...
impact: Adds a first-position drawer tab that reconstructs and displays the current todo list for the active chat session from todo tool trace metadata.
---
